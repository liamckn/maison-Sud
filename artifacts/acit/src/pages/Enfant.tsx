...
export function Enfant() {
  return (
    <PageLayout title="Enfant" subtitle="Collection Été 2026">
      <div className="py-20 sm:py-32 flex flex-col items-center gap-4 text-center border border-border/10">
        ...
        <p className="text-3xl sm:text-4xl font-display font-bold uppercase tracking-wider text-foreground/20">Collection Enfant</p>
